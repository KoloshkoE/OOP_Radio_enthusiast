...
public class RadioTest {
    ...
    public void setprevStationTest(int volumeSound) {
        ...
        int exepceted;
        curnextstat.currentRadioStation = volumeSound;
        curnextstat.prev();
        if (volumeSound > 0) {
        ...
        int actual = curnextstat.currentRadioStation;
    ...
    public void setCurvolSoundTest(int volumeSound) {
        ...
        int exepceted;
        curvolsound.currentVolume = volumeSound;
        ...
        int actual = curvolsound.currentVolume;
        Assertions.assertEquals(exepceted, actual);
